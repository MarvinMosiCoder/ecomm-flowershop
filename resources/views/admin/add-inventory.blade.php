    ...
    <form action='{{CRUDBooster::mainpath('add-save')}}' method="POST" id="InventoryForm" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label"><span style="color:red">*</span> Type of Flower</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label"><span style="color:red">*</span> Flower Name</label>
                    <input type="text" class="form-control binput" placeholder="Flower Name" name="flower_name" id="flower_name">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label"><span style="color:red">*</span> Percentage Sale</label>
