<?php namespace App\Http\Controllers;
	...
	class AdminOrdersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Drop Address","name"=>"drop_address"];
			$this->col[] = ["label"=>"Price","name"=>"price"];
			$this->col[] = ["label"=>"Prod Id","name"=>"prod_id","join"=>"inventory_tbl,id"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Drop Address","name"=>"drop_address","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Price","name"=>"price","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Prod Id","name"=>"prod_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"prod,id"];
