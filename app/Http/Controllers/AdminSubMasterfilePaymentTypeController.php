<?php namespace App\Http\Controllers;
	...
	class AdminSubMasterfilePaymentTypeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "sub_masterfile_payment_type";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Payment Name','name'=>'payment_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
