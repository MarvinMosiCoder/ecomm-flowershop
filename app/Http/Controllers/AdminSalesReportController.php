<?php namespace App\Http\Controllers;
	...
	class AdminSalesReportController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		public function getIndex(Request $request) {
			...
			if(in_array(CRUDBooster::myPrivilegeId(),[1,3])){
				...
				->whereDate('date_of_purchase', $todayDate)
				->get()->toArray();
			...
			return $this->view("admin.daily-sales-report", $data);
		}
